...
const renderBubble = props => { return ( <Bubble {...props} textStyle={{ right: { color: 'white', }, }} wrapperStyle={{ right: { backgroundColor:'#0081f1', }, }} /> ); }
...
export default function Page() {
    ...
    if (isLoading) {
      return (
        <View p="$3"><ActivityIndicator /></View>
      )
    }
