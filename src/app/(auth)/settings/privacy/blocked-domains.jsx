...
export default function Page() {
  ...
  const RenderEmpty = () => (
    <View flexGrow={1} justifyContent="center" alignItems="center" py="$5">
      <YStack flexShrink={1} justifyContent="center" alignItems="center" gap="$5">
        ...
        <Text fontSize="$7" allowFontScaling={false}>You are not blocking any domains</Text>
      </YStack>
    </View>
  )
  ...
  return (
    <SafeAreaView style={{ flex: 1 }} edges={['bottom']}>
      ...
      />
      <View p="$5">
        <Text>To add or delete blocked domains, navigate to Privacy Settings from a web browser.</Text>
      </View>
      <FlatList
        data={data}
