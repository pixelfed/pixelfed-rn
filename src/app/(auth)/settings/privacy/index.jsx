            ...
            <ScrollView flexShrink={1}>
                <YStack p="$5" gap="$3">
                    <Group orientation="vertical" separator={<Separator borderColor="$gray2" />}>
                        <GroupButton icon="lock" title="Account Privacy" path="/settings/privacy/privacy-settings" />
                    </Group>

                    <Group orientation="vertical" separator={<Separator borderColor="$gray2" />}>
                        <GroupButton icon="user-minus" title="Muted Accounts" path="/settings/privacy/muted-accounts" />
                        <GroupButton icon="user-x" iconColor="red" title="Blocked Accounts" path="/settings/privacy/blocked-accounts" />
                        <GroupButton icon="external-link" title="Blocked Domains" path="/settings/avatar" />
                    </Group>
                </YStack>
            </ScrollView>
        </SafeAreaView>
