...
export default function Screen() {
    ...
    const GroupButton = ({ icon, title, path }) => (
      <Group.Item>
        <Button onPress={() => openLink(path)} bg="$gray1" justifyContent="start" size="$5" px="$3">
        ...
        <SafeAreaView flex={1} edges={['bottom']}>
            ...
            <ScrollView flexShrink={1}>
                <YStack gap="$5">
                    ...
                    <XStack p="$5" bg="$background" justifyContent="space-between" alignItems="center" borderRadius={"$3"}>
                        <YStack maxWidth='60%' gap="$2">
                            <Text fontSize="$5" fontWeight={'bold'}>Dark Mode</Text>
                            <Text fontSize="$3" color="$gray9">Enable dark mode design</Text>
                        </YStack>
                        <Switch size="$3" defaultChecked={darkMode} value={darkMode} onCheckedChange={setDarkMode}>
