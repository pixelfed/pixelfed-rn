        ...
        <SafeAreaView flex={1} edges={['bottom']}>
            ...
            <ScrollView flexShrink={1}>
                <YStack p="$5" gap="$5">
                    ...
                    <Button onPress={() => openExternalLink('github.com/pixelfed/pixelfed')} bg="$gray1" justifyContent="start" size="$5" px="$3">
                        <XStack flexGrow={1} justifyContent="space-between" alignItems="center">
                            <XStack alignItems="center" ml="$1" gap="$3">
                    ...
                    <Button onPress={() => openExternalLink('github.com/pixelfed/pixelfed-rn')} bg="$gray1" justifyContent="start" size="$5" px="$3">
                        <XStack flexGrow={1} justifyContent="space-between" alignItems="center">
                            <XStack alignItems="center" ml="$1" gap="$3">
                            <Feather name="code" size={17} color="#666" />
